...
def test_tool_result_forwarded_in_second_api_call(generator, tool_defs):
    generator.client.messages.create.side_effect = [
        _tool_use_response(
            "search_course_content", {"query": "MCP"}, tool_id="tid_abc"
        ),
...
def test_single_api_call_for_direct_answer(generator, tool_defs):
    ...
    generator.generate_response(
        query="what is 2+2?", tools=tool_defs, tool_manager=MagicMock()
    )
...
def test_tool_manager_not_called_on_direct_answer(generator, tool_defs):
    ...
    generator.generate_response(
        query="2+2?", tools=tool_defs, tool_manager=tool_manager
    )
...
def test_second_call_has_no_tools_key(generator, tool_defs):
    ...
    generator.generate_response(
        query="MCP?", tools=tool_defs, tool_manager=tool_manager
    )
...
def test_two_round_flow_makes_three_api_calls(generator, tool_defs):
    generator.client.messages.create.side_effect = [
        _tool_use_response(
            "get_course_outline", {"course_name": "MCP"}, tool_id="tid_r1"
        ),
        _tool_use_response(
            "search_course_content", {"query": "lesson 4 topic"}, tool_id="tid_r2"
        ),
...
def test_tool_manager_called_twice_in_two_round_flow(generator, tool_defs):
    generator.client.messages.create.side_effect = [
        ...
        _tool_use_response(
            "search_course_content", {"query": "topic"}, tool_id="tid_r2"
        ),
        _text_response("Final answer"),
    ]
    tool_manager = MagicMock()
...
def test_intermediate_call_includes_tools(generator, tool_defs):
    generator.client.messages.create.side_effect = [
        _tool_use_response(
            "get_course_outline", {"course_name": "X"}, tool_id="tid_r1"
        ),
        _tool_use_response(
            "search_course_content", {"query": "topic"}, tool_id="tid_r2"
        ),
...
def test_accumulated_messages_in_final_call(generator, tool_defs):
    ...
    third_call_messages = generator.client.messages.create.call_args_list[2][1][
        "messages"
    ]
